...
func (qjrPersistentVolumeClaim *QueueJobResPersistentVolumeClaim) GetAggregatedResources(job *arbv1.XQueueJob) *schedulerapi.Resource {
...
func (qjrPersistentVolumeClaim *QueueJobResPersistentVolumeClaim) GetAggregatedResourcesByPriority(priority int, job *arbv1.XQueueJob) *schedulerapi.Resource {
